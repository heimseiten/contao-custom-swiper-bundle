...
PaletteManipulator::create()   
    ...
    ->addLegend('CustomSwiper', 'slider_legend', PaletteManipulator::POSITION_AFTER)

    ->addField('sliderEffect', 'CustomSwiper', PaletteManipulator::POSITION_PREPEND)
    
    ->addField('sliderButtons', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderPagination', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderKeyboardControl', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderScrollbar', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderAutoheight', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderNotDisableOnInteraction', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderVertical', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderThumbs', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderThumbsSlidesPerView', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    
    ->addField('sliderBreakpoint1', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderSlidesPerViewBreakpoint1', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderSlidesPerGroupBreakpoint1', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderSpaceBetweenBreakpoint1', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderCenteredSlidesBreakpoint1', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)

    ->addField('sliderBreakpoint2', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderSlidesPerViewBreakpoint2', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderSlidesPerGroupBreakpoint2', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderSpaceBetweenBreakpoint2', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderCenteredSlidesBreakpoint2', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)

    ->addField('sliderBreakpoint3', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderSlidesPerViewBreakpoint3', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderSlidesPerGroupBreakpoint3', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderSpaceBetweenBreakpoint3', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderCenteredSlidesBreakpoint3', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)

    ->addField('sliderBreakpoint4', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderSlidesPerViewBreakpoint4', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderSlidesPerGroupBreakpoint4', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderSpaceBetweenBreakpoint4', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
    ->addField('sliderCenteredSlidesBreakpoint4', 'CustomSwiper', PaletteManipulator::POSITION_APPEND)
